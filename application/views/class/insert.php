...
<div class="card shadow mb-4">
  ...
  <div class="row">
    ...
    <div class="card-body">
            <form class="user" method="post" enctype="multipart/form-data" action="<?php echo base_url('ClassStudy/insert') ?>">
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 ">
                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                            placeholder="Tên lớp" name="name" value=<?= set_value('name') ?>>
